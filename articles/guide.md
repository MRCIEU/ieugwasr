...
5.  To check that your token is being recognised, run
    [`ieugwasr::get_opengwas_jwt()`](https://mrcieu.github.io/ieugwasr/reference/get_opengwas_jwt.md).
    If it returns a long random string then you are authenticated.
6.  To check that your token is working, run
    [`user()`](https://mrcieu.github.io/ieugwasr/reference/user.md). It
...
operations](https://mrcieu.github.io/ieugwasr/articles/local_ld.md)
