...
PheWAS can also be performed in only specific subsets of the data. The datasets in the OpenGWAS database are organised by batch, you can see info about it here: https://opengwas.io/datasets/ or get a list of batches and their descriptions using:
...
And a list of variants within a particular gene region can also be found. Provide an Ensembl or Entrez gene ID (e.g. ENSG00000123374 or 1017) to the following:
...
Use the [mygene](https://bioconductor.org/packages/mygene) bioconductor package to query the [mygene.info](https://docs.mygene.info) API.
