...
This is a `r format(radius * 2, scientific = FALSE, big.mark = ",")` size window, which has `r length(rsid)` variants to lookup.
...
This `r length(chrpos)` ranges of `r format(20000, scientific = FALSE, big.mark = ",")` size window, which is covered by `r length(rsid)` variants to lookup.
